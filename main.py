...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--all',       action='store_true', dest='all_files', help='flag to process even those which do not start with "Screenshot_"')
    ...
    if (args.width != 1271 or args.height != 761) and not args.view and not args.wizard:
        ...
        pass
    match (args.wizard, args.view, args.path is not None, args.type, args.directory, args.cropped, args.both, args.all_files):
        # script
