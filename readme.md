The current script is aimed to automatically crop result windows of the PolyAnalyst nodes to save time for the Technincal writers team when making nodes settings windows screenshots (see examples).
